  ...
  {searchItems.map((item)=>(
    <FoodCard data={item} key={item._id}/>
      ...
      <div className="w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]">
        ...
        <h1 className='text-gray-800 text-1xl font-bold sm:text-3xl'>Inspiration for your first order</h1>
...
<FaCircleChevronRight />
      ...
      <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
 <h1 className='text-gray-800 text-1xl font-bold sm:text-3xl'>Best Shop in {currentCity}</h1>
 <div className='w-full relative'>
...
<FaCircleChevronRight />
      ...
      <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
       <h1 className='text-gray-800 text-1xl font-bold sm:text-3xl'>
